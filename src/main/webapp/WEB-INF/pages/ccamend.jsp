    ...
    <section class="global-page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h2>Supplementary Credit Card Amend</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="home">
                            ...
                            <li class="active">Credit Card Amend</li>
                        </ol>
                    </div>
                </div>
            </div>
...
================================================== -->
    <section id="about">
        ...
        <h2 class="subtitle wow fadeInUp animated" data-wow-delay=".3s" data-wow-duration="500ms">Now Trending</h2>
            ...
            <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
                <h1>
                    Supplementary Credit Card Amend
                    </h1>
                <br>
                <div class="col-sm-3 col-md-6 col-lg-4">
                <p>Please input supplementary Credit Card that needs to be amended
  ...
  <div class="form-group">
                                <label for="usr">Supplementary Sema Number:</label>
                                <input type="text" class="form-control" id="sema_num">
                            </div>
                            <div class="form-group">
                                <label for="usr">Group Account Number:</label>
                                <input type="number" class="form-control" id="gp_acc_num" onkeypress="return isNumberKey(event)">
                            </div>
                            <button type="button" class="btn btn-default" onclick = "ValidateCCUpdateSup()">Validate</button>
                            <!--div class="thumbnail">
...
<img class="img-responsive" src="<c:url value="/resources/images/right.png" />"  height="42" width="42" alt="Chania">
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-8" id= "ValidateCCUpdate"  style="display:none" >
                            ...
                            <button type="button" class="btn btn-default" onclick="UpdateCC()">Update</button>
                             <button type="button" class="btn btn-default" onclick="ReActivateCCSup()">Re-Activate</button>
                             <button type="button" class="btn btn-default" onclick="DeActivateCCSup()">Deactivate</button>
                            </div>
...
<div class="loader" ></div> 
    ...
    <footer id="footer">
        <div class="container">
            <div class="col-md-8">
                <p class="copyright">Copyright: <span><script>document.write(new Date().getFullYear())</script></span> Design and Developed by <a href="#" target="_blank">Digital and Devlopment team</a>.
                    <br>
